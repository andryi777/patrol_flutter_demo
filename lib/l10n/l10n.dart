...
final Map<String, Map<String, String>> localizedValues = {
  'en': {
    ...
    'language_explanation': 'The app will use the selected language for all text.',
    'change_language': 'Change app language',
    'theme': 'Theme',
    'change_theme': 'Change app appearance',
    'notifications': 'Notifications',
    'notification_settings': 'Manage notifications',
    'localization_demo': 'Localization Demo',
    'localization_demo_description': 'See localization examples',
    'logout': 'Logout',
    'login': 'Login',
    'email': 'Email',
    'password': 'Password',
  ...
  'es': {
    ...
    'select_your_language': 'Selecciona tu idioma preferido',
    'language_explanation': 'La app usará el idioma seleccionado para todo el texto.',
    'change_language': 'Cambiar idioma de la app',
    'theme': 'Tema',
    'change_theme': 'Cambiar apariencia de la app',
    'notifications': 'Notificaciones',
    'notification_settings': 'Administrar notificaciones',
    'localization_demo': 'Demo de Localización',
    'localization_demo_description': 'Ver ejemplos de localización',
